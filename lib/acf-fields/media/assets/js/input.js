...
(function( $ ) {
  ...
  const MediaField = acf.Field.extend({
    ...
    validateValue: function() {
      ...
      if( !isObject(value) ) value = { file: false, poster: false, mobile: false, file_dark: false, mobile_dark: false, rive_playback: 0 };

      return value;
    },
    validateEmptiness: function(value) {
      if( value.file === false && value.poster === false && value.mobile === false && value.file_dark === false && value.mobile_dark === false ) return false;
      return value;
    },
